...
public class ByteDoMilhao {
  ...
  public static String comoJogoFunciona(){
  ...
  public static void menu(){
    String mensagem = comoJogoFunciona();
  ...
  public static void falaInicial(String nome, String suaPatente) {
    if (nome.equals("Mestre")) {
      System.out.printf("Vejamos se não temos um mestre entre nós. Acho que este teste sera facil para o senhor mas mesmo assim vamos te colocar na posição de %s\n", suaPatente);
    } else if (nome.equals("Senhor Thiagolo")) {
      System.out.printf("Vejamos se não estamos com ele, com o magnifico, o grande, o incrivel, o SENHOR dos senhores, %s. Vamos ver se voce é capaz deste desafio, vamos ver como o senhor se sai começando como %s\n", nome, suaPatente);
    }else{
